...
const experienceItems: TimelineItem[] = [
  {
    ...
    location: 'Remote',
    skills: ['Python', 'MySQL', 'JavaScript', 'HTML', 'CSS']
  },
  {
    type: 'experience',
    ...
    location: 'Remote',
    skills: ['Node.js', 'Express.js', 'MongoDB', 'RESTful APIs', 'Git', 'React']
  }
];
...
const Timeline: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto p-4 bg-gray-100 dark:bg-gray-900 rounded-lg shadow">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-900 dark:text-white">Education & Experience</h1>
